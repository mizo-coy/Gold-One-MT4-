        ...
        <div className="container mx-auto px-4 py-20 lg:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-2 border-amber-500/50 rounded-full px-4 sm:px-6 py-2 sm:py-3 shadow-xl">
                <Sparkles className="h-4 w-4 sm:h-5 sm:w-5 text-amber-400" />
                <span className="text-amber-400 text-xs sm:text-sm font-bold uppercase tracking-wide">Exclusive Offer</span>
                <span className="px-2 py-0.5 bg-red-500 text-white text-xs font-bold rounded-full animate-pulse">25% OFF</span>
                <span className="text-white text-sm sm:text-base font-bold">Save $25!</span>
                <span className="text-gray-500">•</span>
                <span className="text-gray-400 text-xs sm:text-sm">Ends:</span>
